...
public class Bajaj extends Bike {
  String makeType;
  Bajaj(double mileage, double price, int numberOfCylinder,int numberOfGears,String coolingType,String wheelType,double fuelTankSize,String warranty,String makeType){
